...
O grafo oficial de entrada deste trabalho é o representado na figura `imgs/graph.png`, baseada no material discutido em [instrucoes.md](./instrucoes.md). A ideia central é separar o trabalho em duas partes:
...
- os vértices desbalanceados identificados;
- as arestas adicionadas para balanceamento;
- a implementação do método de Hierholzer;
- a execução do programa;
- a interpretação da saída produzida.
