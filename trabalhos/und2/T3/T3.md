...
<img src="imgs/grafo_semi_euleriano.png" width="800">

Um circuito euleriano válido para o exemplo eulerizado fornecido é:

```text
v1 v3 v2 v4 v1 v2 v5 v1 v4 v3 v2 v5 v1
```

com custo de 24 (acompanhe o circuto pelas arestas do grafo eulerizado).
