...
- Caso o aluno adapte `DirectedEulerianCycle` para trabalhar diretamente com arestas ponderadas e também retornar o custo do circuito, pode usar como referência adicional `EdgeWeightedDigraph.java` ou `edge_weighted_digraph`.
